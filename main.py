...
# # seaborn Countplot
# sns.set_theme()
# Snsbirddata = sns.load_dataset("bird_tracking.csv")
# sns.relplot(
#      data=Snsbirddata,
#      x="bird_name", y="speed_2d", col="time")


#check the columns of dataset
birddata.column
# check first few entries of date_time
birddata.date_time[0:3]

#returns the current Date (yy-mm-dd) & time
...
# Drop dupilcates of bird names
#Dupes_dropped = birddata.drop_duplicates(subset="bird_name")
#print(Dupes_dropped)
